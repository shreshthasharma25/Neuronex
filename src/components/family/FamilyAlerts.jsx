  ...
  return (
    <div className="space-y-6">
      ...
      <div className="p-4 sm:p-5 rounded-2xl sm:rounded-3xl bg-[#FFF6E5] border border-[#F3E2C4] flex flex-col sm:flex-row sm:items-center justify-between gap-3">
        ...
        <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl bg-white text-[#D98A1E] border border-[#F3E2C4] flex items-center justify-center text-xl sm:text-2xl shadow-sm flex-shrink-0 self-start sm:self-auto">
          🔔
        </div>
      </div>
              ...
              >
                <div className="flex items-start gap-3 sm:gap-3.5 min-w-0">
                  <div className={`w-9 h-9 sm:w-10 sm:h-10 rounded-xl sm:rounded-2xl flex items-center justify-center text-lg sm:text-xl flex-shrink-0 mt-0.5 ${
                    isWarning ? 'bg-rose-100 text-rose-700' : 'bg-white text-[#1E5E3A] border border-[#D8E2D9]'
                  }`}>
                    {isWarning ? '⚠️' : '✓'}
                  </div>
