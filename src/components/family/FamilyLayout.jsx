...
import { GamosaRibbon, RegionalTextileBorder } from '../common/CulturalMotifs';
        ...
        <div className="flex items-center justify-between gap-1.5 sm:gap-2">
          ...
          <div className="flex items-center gap-1.5 sm:gap-3 min-w-0 flex-1">
            <button
              ...
              className="p-2 rounded-xl text-slate-500 hover:text-[#162832] hover:bg-slate-100 transition-colors sm:hidden flex-shrink-0 touch-target flex items-center justify-center"
            ...
            <div className="min-w-0">
              <div className="flex items-center gap-1.5 flex-wrap">
                ...
                <span className="px-1.5 sm:px-2 py-0.5 rounded-full bg-[#EBF5EE] text-[#1E5E3A] border border-[#D8E2D9] text-[10px] sm:text-xs font-extrabold flex-shrink-0">
                  {t('role.familyRole')}
                </span>
              </div>
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 flex-shrink-0">
            ...
            <button
              ...
              className="hidden md:flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#FFF6E5] hover:bg-[#FBEED7] text-[#D98A1E] text-xs font-bold border border-[#F3E2C4] transition-all"
            >
            ...
            <button
              ...
              className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#EBF5EE] hover:bg-[#D8E2D9] text-[#1E5E3A] text-xs font-bold border border-[#D8E2D9] transition-all"
            >
            ...
            <button
              ...
              className="flex md:hidden items-center gap-1 px-2 sm:px-2.5 py-1.5 rounded-xl bg-[#EBF5EE] text-[#1E5E3A] border border-[#D8E2D9] text-xs font-bold max-w-[110px] sm:max-w-[130px] truncate touch-target"
              ...
              <div className="mt-3.5 pt-3 border-t border-slate-100 space-y-2">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <button
                    ...
                    className="flex items-center justify-center gap-1.5 px-3 py-2 rounded-xl bg-[#FFF6E5] hover:bg-[#FBEED7] text-[#D98A1E] text-xs font-extrabold border border-[#F3E2C4] transition-all min-h-[42px] touch-target"
                  >
                    <span>🩺</span>
                    <span>Caregiver</span>
                  </button>
