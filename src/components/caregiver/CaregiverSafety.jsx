    ...
    <div className="space-y-6">
      ...
      <Card variant="white" className="p-4 sm:p-5 border-2 border-dashed border-amber-300 bg-amber-50/50">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
          <div>
            <h4 className="text-xs sm:text-sm font-extrabold text-[#162832] flex items-center gap-2">
      ...
      <Card variant="white" className="p-4 sm:p-6">
        <h3 className="text-base font-extrabold text-[#162832] mb-4 flex items-center gap-2">
          <MapPin className="w-4 h-4 text-[#1E5E3A]" />
        ...
        <form onSubmit={handleSaveHome} className="space-y-4">
          ...
          <div className="p-4 rounded-2xl bg-slate-50 border border-slate-200 space-y-3">
            <div className="flex flex-wrap items-center justify-between gap-2">
              <div>
                <span className="text-xs font-extrabold text-[#162832] block">
              ...
              <button
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-[#1E5E3A] hover:bg-[#164E30] text-white text-xs font-bold shadow-xs transition-all disabled:opacity-50"
              >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 rounded-xl border border-slate-200 text-xs font-mono font-medium focus:border-[#1E5E3A] focus:outline-none bg-white"
                />
              </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-1">
              <label className="text-xs font-bold text-[#162832]">
                Safe Zone Radius: <strong className="text-[#1E5E3A]">{safeZone} meters</strong>
              </label>
            ...
            <input
              ...
              className="w-full h-2 bg-slate-100 rounded-lg appearance-none cursor-pointer accent-[#1E5E3A]"
            />
